# Technical Report — eng-api-black_box-9f8c98ed

## Findings

| Severity | Priority | Risk | Detection | Title | Asset | CVEs | ATT&CK | Sources |
|---|---|---|---|---|---|---|---|---|
| info | info | 10.0 | UNKNOWN | Add DOM EventListener - Detection | https://www.esds.co.in | - | T1189 | nuclei |
| info | info | 10.0 | UNKNOWN | HTTP Missing Security Headers | https://www.esds.co.in | - | - | nuclei |
| info | info | 10.0 | UNKNOWN | WAF Detection | https://www.esds.co.in | - | - | nuclei |
...
- `www.esds.co.in` (risk 10.0): T1189(UNKNOWN) → T1190(UNKNOWN) → T1203(UNKNOWN) → T1046(UNKNOWN) → ?(UNKNOWN) → ?(UNKNOWN) → ?(UNKNOWN)
